    ...
    <FrontLayout>
      <main className="donations">
        <section className="donations-1 ">
          <div className="donate-text d-flex flex-column justify-content-md-center">
        ...
        <section className="donations-2 pb-3 pb-lg-0">
          <div className="container pt-5">
            ...
            <div className="pay-don text-center mb-5">
