      ...
      <main className="revival">
        ...
        <section className="second">
          <div className="d-flex align-items-md-center flex-column flex-md-row">
            ...
            <div className="right">
              <img src="/images/revival_images/home_2.png" alt="" />
            </div>
          </div>
        </section>
            ...
            {third.map((card) => (
              <div className="col three-" key={card.id}>
                <div
                  ...
                  style={{
                    background: `url(/images/revival_images/third_${card.id}.png)`,
                    height: "33.2rem",
          ...
          <div className="container mg">
            ...
            <div className="fourth-main  d-flex flex-column align-items-center align-items-md-start justify-content-center flex-md-row">
              <div className="avatar me-5">
                <img
                  src="/images/revival_images/fourth.png"
                  alt=""
        ...
        <section className="fifth py-5">
          <div className="container">
            <p className="h1 fw-700 font-48 mb-4">
              Love Revival{" "}
              <span className="concert h1 fw-700 font-48">Concerts</span>
            </p>
        ...
        <section className="sixth">
          <div className="container">
            <p className="h1 fw-700 font-48 mb-4">
              Love Revival Gallery{" "}
              <span className="gallery h1 fw-700 font-48">Concerts</span>
            </p>
            <p className="text-muted">
              Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur. <br /> Excepteur sint
            ...
            <div className="image-box">
              <div className="d-flex justify-content-between">
                <div className="p-lg-3 img-1">
                  <img
                    src="/images/revival_images/sixth_1.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
                <div className="p-lg-3 img-2">
                  <img
                    src="/images/revival_images/sixth_2.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
              ...
              <div className="d-flex justify-content-between">
                <div className="p-lg-3 img-3">
                  <img
                    src="/images/revival_images/sixth_3.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
                <div className="p-lg-3 img-4">
                  <img
                    src="/images/revival_images/sixth_4.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
                <div className="p-lg-3 img-5">
                  <img
                    src="/images/revival_images/sixth_5.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
              ...
              <div className="d-flex justify-content-between">
                <div className="p-lg-3 img-6">
                  <img
                    src="/images/revival_images/sixth_6.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
                <div className="p-lg-3 img-7">
                  <img
                    src="/images/revival_images/sixth_7.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
                <div className="p-lg-3 img-8">
                  <img
                    src="/images/revival_images/sixth_8.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
          ...
          <div className="container d-lg-flex justify-content-around">
            <div className="left d-flex">
              <div className="left-image me-3">
                <img
                  src="/images/revival_images/monitor 1.svg"
                  alt=""
                  className="img-fluid"
                />
              </div>
            ...
            <div className="right d-flex">
              <div className="right-image me-3">
                <img
                  src="/images/revival_images/Group.svg"
                  alt=""
                  className="img-fluid"
                />
              </div>
              ...
              <div className="card me-auto ms-auto revived-card">
                <div className="card-img-top">
                  <div className="revived-card-image">
                    <img
                      src="/images/revival_images/lives_revived.png"
                      alt=""
        ...
        <section className="nine py-5 position-relative">
          <div className=" container-fluid ">
            ...
            >
              <img src="/images/revival_images/spon1.png" alt="" />
              <img src="/images/revival_images/spon2.png" alt="" />
              <img src="/images/revival_images/spon1.png" alt="" />
              <img src="/images/revival_images/spon2.png" alt="" />
              <img src="/images/revival_images/spon1.png" alt="" />
              <img src="/images/revival_images/spon2.png" alt="" />
