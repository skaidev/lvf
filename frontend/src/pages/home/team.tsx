...
const teamPage = (): JSX.Element => {
  return (
    <LoveHomeLayout>
      <main className="home-team">
        <section className="home-team-1">
          <div className="team-text d-flex align-items-end">
            <div className="container">
              ...
              <p className="fw-400 font-24 pb-3 text-light">
                The best of of our team and volunteers around the world
              </p>
            </div>
          </div>
        </section>
        <section className="home-team-2 py-5">
          <div className="container">
              ...
              {teamCard.map((card) => (
                <div className="col team- " key={card.id}>
                  <div
                    ...
                    style={{
                      background: `url(/images/home_images/team-${card.image}.png) no-repeat`,
                    }}
                  >
