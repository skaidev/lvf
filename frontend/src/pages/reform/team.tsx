...
const teamPage = (): JSX.Element => {
  return (
    <ReformLayout>
      <main className="reform-team">
        <section className="reform-team-1">
        ...
        <section className="reform-team-2 py-5">
                ...
                <div className="col team-card mb-5" key={card.id}>
                  <div className="card border-primary me-auto ms-auto position-relative team-card-wrap border-0 h-100">
                    <img
                      ...
                      src={`/images/reform_images/founder_${card.img}.png`}
                      alt="team"
                    />
        ...
        <section className="reform-team-3">
