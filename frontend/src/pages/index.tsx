			...
			<main className="home">
				...
				<section className="home-1">
					<div className="container mb-5">
						<div className="home-1_about" id="about">
							<div className="d-md-flex align-items-center inner">
								...
								<div className="right d-none d-md-block">
									<div className="right-top">
										<div className="img-1">
											<img src="/images/foundation_images/about-1.png" alt="" />
										</div>
										<div className="img-2">
											<img src="/images/foundation_images/about-2.png" alt="" />
										</div>
									</div>
									<div className="right-bottom">
										<div className="img-3">
											<img src="/images/foundation_images/about-3.png" alt="" />
										</div>
										<div className="img-4">
											<img src="/images/foundation_images/about-4.png" alt="" />
										</div>
									</div>
								</div>
							</div>
							...
							{raiseFund.map((one) => (
								<div className="col" key={one.id}>
									<div className="card fund-card border-0 h-100">
										<img
											src={`./images/foundation_images/arms_${one.id}.png`}
											alt=""
											className="card-img"
										/>
										<div className="card-body">
											...
											<Link href={one.to}>
												<a className="btn text-primary border-3 rounded border-primary px-4">
													{one.btnTxt}
												</a>
											</Link>
										</div>
				...
				<section className="home-4 pt-5">
					...
					<div className="partners d-flex align-itmes-center">
						...
						>
							<img src="./images/foundation_images/spon1.png" alt="" />
							<img src="./images/foundation_images/spon2.png" alt="" />
							<img src="./images/foundation_images/spon1.png" alt="" />
							<img src="./images/foundation_images/spon2.png" alt="" />
							<img src="./images/foundation_images/spon1.png" alt="" />
							<img src="./images/foundation_images/spon2.png" alt="" />
				...
				<section className="home-volunteer bg-primary">
					<div className="container d-flex flex-column flex-md-row justify-content-around py-5">
						<div className="volunteer d-flex flex-column justify-content-center align-items-center">
							<img
								src="/images/foundation_images/hands_1.png"
								alt=""
								className="pb-4"
							/>
						...
						<div className="volunteer d-flex flex-column justify-content-center align-items-center">
							<img
								src="/images/foundation_images/hands_2.png"
								alt=""
								className="pb-4"
							/>
						...
						<div className="volunteer d-flex flex-column justify-content-center align-items-center">
							<img
								src="/images/foundation_images/hands_3.png"
								alt=""
								className="pb-4"
							/>
							<p className="fw-700 font-48">700+</p>
						...
						<div className="volunteer d-flex flex-column justify-content-center align-items-center">
							<img
								src="/images/foundation_images/hands_4.png"
								alt=""
								className="pb-4"
							/>
				...
				<section className="home-5 py-5" id="team">
					<div className="container">
						...
						<p className="text-muted text-center mb-4">
							...
							limit to what you can do, from bake sale to a 10k run your efforts
							will help give a local person in crisis much more than food, but
							hope for the future.
						</p>
							...
							{team.map((team) => (
								<div className="col team- " key={team.id}>
									<div
										...
										style={{
											background: `url(./images/foundation_images/team-${team.id}.png) no-repeat`,
										}}
									>
